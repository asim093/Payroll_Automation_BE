...
const { scanShareFileForNewFiles } = require('./services/sharefileService');
...
const processShareFileScan = async () => {
  ...
  if (newFiles.length === 0) {
    ...
    return { clientsScanned, newFilesFound: 0, saved: 0, failed: 0 };
  }
  ...
  return { clientsScanned, newFilesFound: newFiles.length, saved, failed };
};
